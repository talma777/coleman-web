...
export default function TheFirm() {
  ...
  const executiveTeam = [
    ...
    { name: "Kathryn Davis", role: "ASSOCIATE DIRECTOR OF ENGAGEMENT", bio: "Kathryn is responsible for encouraging and facilitating member engagement across the network, including event management for all COLEMAN conferences.", img: "https://russellbedford.com/media/8086/kathryn.jpg" },
    { name: "Abby Catchpowle", role: "MARKETING MANAGER", bio: "Abby is the Marketing and Communications Manager at COLEMAN, working closely on marketing, communications and brand initiatives.", img: "https://russellbedford.com/media/10188/abby-transparent-bg.png" },
    { name: "Hira Asghar Akhtar", role: "MARKETING ASSISTANT", bio: "Hira joined COLEMAN in May 2024. She has experience with social media marketing, design and content creation.", img: "https://russellbedford.com/media/10191/hira2_preview_rev_1.png" },
    { name: "Romina Sanabria", role: "LATAM COORDINATOR", bio: "Romina manages and enhances communications with the network's Spanish speaking member firms.", img: "https://russellbedford.com/media/7454/romina-sanabria-scaled.jpg" },
    { name: "Gemma Benson", role: "ADMINISTRATOR", bio: "Gemma has worked as an Administrator for over 20 years. She is a valuable support to the central office.", img: "https://russellbedford.com/media/5926/gemma-benson.jpg" },
